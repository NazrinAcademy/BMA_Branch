...
import { fetchUnits, addNewUnit, deleteUnit, updateUnit } from "../../api/unitAPI"; // Import your API functions
import * as XLSX from "xlsx";
import { jsPDF } from "jspdf";
import successImage from '../../assets/success.png'
import { useSelector } from "react-redux";
import SuccessMessage from "../../components/common/SuccessMessage";
import UnitModal from "../product/UnitModal";
import UnitTable from "../product/UnitTable";


const Units = () => {
  const [units, setUnits] = useState([
    { id: 1, unit: "m" , full_name:"meter", allow_decimal:"yes"},
    { id: 2, unit: "kg" , full_name:"kilogram", allow_decimal:"no"},
    { id: 3, unit: "box" , full_name:"box", allow_decimal:"no"},
    { id: 4, unit: "pkt" , full_name:"pocket", allow_decimal:"yes"},
]);
...
// const handleCloseOverlay = () => setShowOverlay(false);
  ...
  const handleUpdate = async () => {
    if (!updatedUnit.unit || !updatedUnit.full_name) {
    ...
    try {
      const payload = {
        ...
        full_name: updatedUnit.fullName,
  ...
  const handleEdit = (unit) => {
    ...
    setUnitFullName(unit.full_name);
