...
const PrintInvoice = ({
  ...
  return (
    <div className="max-w-3xl h-auto mx-auto bg-white font-['Plus_Jakarta_Sans'] p-6 shadow-lg border rounded-lg">
      ...
      <div className="flex justify-between items-center pb-4 mb-4">
        <h1 className="text-xl font-bold text-center w-full">Sale Invoice</h1>
      </div>
  ...
  <div className="grid grid-cols-2 gap-4 mt-4 text-sm border-b pb-4">
        <div className="font-medium">
          <p>
            <span className="font-normal">Customer Name:</span> {invoiceData.billing_to}
          </p>
          <p>
      ...
      <thead>
        ...
        <tbody>
          <tr className="border font-normal">
            ...
            <td className="p-2 border">{invoiceData.product_name}</td>
                    <td className="p-2 border">{invoiceData.hsn_sac_code}</td>
                    <td className="p-2 border">{invoiceData.qty}</td>
                    <td className="p-2 border">{invoiceData.rate}</td>
                    <td className="p-2 border">{invoiceData.discount_percentage}</td>
                    <td className="p-2 border">{invoiceData.discount_value}</td>
                    <td className="p-2 border">{invoiceData.cgst_percentage}</td>
                    <td className="p-2 border">{invoiceData.cgst_value}</td>
                    <td className="p-2 border">{invoiceData.sgst_percentage}</td>
                    <td className="p-2 border">{invoiceData.sgst_value}</td>
                    <td className="p-2 border">{invoiceData.total_amount}</td>
          </tr>
        </tbody>
      </table>
...
<div className="mt-4 text-sm border border-gray-300 grid grid-cols-2">
  ...
  <div className="p-4 border-r border-gray-300">
    ...
    <p className="font-medium text-lg mt-1">{toWords(invoiceData.amount)}</p>
  </div>
    ...
    <table className="w-full border-collapse">
      <tbody>
        <tr className="border-b">
          ...
          <td className="py-2 text-right w-1/3">₹{invoiceData.total_amount_before_tax}</td>
        </tr>
        <tr className="border-b">
