...
import { CustomerAdd, CustomerDelete, Customerget, CustomerUpdate } from "../../../api/customerAPI";
		...
		CustomerDelete(
			...
			(res) => {
				setFilteredCustomers((prevData) => 
					prevData.filter((item) => item.customer_id !== selectedRowId)
				);
