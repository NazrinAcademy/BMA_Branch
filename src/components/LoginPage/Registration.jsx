...
import { saveOrganizedDetails, savePersonalDetails } from '../../apiService/PGapi';
...
const Registration = () => {
    ...
    const validateOrganizedFields = () => {
        ...
        const allFieldsEmpty = Object.values(organizedData).every(value => !value || value.trim() === "");
        ...
        Object.entries(organizedData).forEach(([key, value]) => {
            if ((!value || value.trim() === "") && !firstError) {
                firstError = `${key.charAt(0).toUpperCase() + key.slice(1).replace(/([A-Z])/g, " $1")} is required`;
            }
        });
    ...
    const handleInputChange = (e) => {
        ...
        if (activeForm === 'personal') {
            setPersonalData((prevData) => {
                ...
                if (id === "company_name" && (!prevData.mailing_name || prevData.mailing_name === prevData.company_name)) {
            ...
            if (id === 'state') {
                setFilteredStates(states.filter(s => s.toLowerCase().includes(value.toLowerCase())));
...
const handleKeyDownState = (e) => {
    ...
    const handleSubmitOrganized = async () => {
        if (validateOrganizedFields()) {
            try {
                await saveOrganizedDetails(organizedData); // Ensure this function exists
    ...
    return (
        <div className="p-4 max-w-6xl mx-auto font-sans">
            ...
            <div className="flex items-center justify-center gap-4 my-10">
                ...
                <div className={`w-44 h-px  ${activeForm === 'organized'
                    ? 'bg-purpleCustom'
                    : 'bg-[#C0C0C0]'}`}>
                </div>
                ...
                <div className="flex items-center">
                    <span
                        className={`w-8 h-8 flex items-center justify-center rounded-full font-bold border ${activeForm === 'organized'
                            ? 'text-purpleCustom border-purpleCustom'
                    ...
                    <span
                        className={`ml-2 text-xs sm:text-base font-semibold ${activeForm === 'organized' ? 'text-purpleCustom' : 'text-[#C0C0C0]'}`}
                    >
                        Organized Details
                    </span>
                </div>
                    ...
                    <div className="flex flex-col space-y-4">
                        ...
                        <div className="relative">
                            <input
                                ...
                                onKeyDown={(e) => handleKeyDown(e, pin_codeRef, address_line1Ref)}
                                placeholder=""
                                className="peer w-full h-9 px-2 text-sm border border-grayCustom focus:outline-none focus:border-purpleCustom rounded-md"
                            />
                    ...
                    <div className="flex flex-col space-y-4">
                        ...
                        <div className="relative">
                            <input
                                ...
                                onChange={handleInputChange}
                                ref={pin_codeRef}
                                onKeyDown={(e) => handleKeyDown(e, mobile_noRef, address_line2Ref)}
                                placeholder=""
                                className="peer w-full h-9 px-2 text-sm border border-grayCustom focus:outline-none focus:border-purpleCustom rounded-md"
                            />
                    ...
                    <div className="text-center">
                        ...
                        <div className="relative">
                            <input
                                ...
                                onKeyDown={(e) => handleKeyDown(e, books_beginning_fromRef, null)}
                                placeholder=""
                                className="peer w-full h-9 px-2 text-sm border border-grayCustom focus:outline-none focus:border-purpleCustom rounded-md"
                            />
                            <label
                        ...
                        <div className="relative">
                            <input
                                ...
                                onKeyDown={(e) => handleKeyDown(e, passwordRef, financial_year_beginRef)}
                                placeholder=""
                                className="peer w-full h-9 px-2 text-sm border border-grayCustom focus:outline-none focus:border-purpleCustom rounded-md"
                            />
                            <label
                    ...
                    <div className="text-center">
                        ...
                        <div className="relative">
                            <input
                                ...
                                onChange={handleInputChange}
                                ref={passwordRef}
                                onKeyDown={(e) => handleKeyDown(e, repeat_passwordRef, books_beginning_fromRef)}
                                placeholder=""
                                className="peer w-full h-9 px-2 text-sm border border-grayCustom focus:outline-none focus:border-purpleCustom rounded-md"
                            />
                        ...
                        <div className="relative">
                            <input
                                ...
                                onKeyDown={(e) => handleKeyDown(e, base_currency_symbolRef, passwordRef)}
                                placeholder=""
                                className="peer w-full h-9 px-2 text-sm border border-grayCustom focus:outline-none focus:border-purpleCustom rounded-md"
                            />
                    ...
                    <div className="text-center">
                        ...
                        <div className="relative">
                            <input
                                ...
                                onKeyDown={(e) => handleKeyDown(e, suffix_symbol_to_amountRef, repeat_passwordRef)}
                                placeholder=""
                                className="peer w-full h-9 px-2 text-sm border border-grayCustom focus:outline-none focus:border-purpleCustom rounded-md"
                            />
                            <label htmlFor='base_currency_symbol'
                                className="absolute left-3 -top-2 text-xs text-[#838383] bg-white px-1 transition-all peer-placeholder-shown:top-2 peer-placeholder-shown:text-sm peer-placeholder-shown:text-[#838383] peer-placeholder-shown:bg-transparent peer-focus:-top-2 peer-focus:text-xs peer-focus:text-[#838383] peer-focus:bg-white"
                            >
                        ...
                        <div className="relative">
                            <input
                                ...
                                value={organizedData.suffix_symbol_to_amount}
                                onChange={handleInputChange}
                                ref={suffix_symbol_to_amountRef}
                                onKeyDown={(e) => handleKeyDown(e, show_amount_of_millionsRef, base_currency_symbolRef)}
                                placeholder=""
                                className="peer w-full h-9 px-2 text-sm border border-grayCustom focus:outline-none focus:border-purpleCustom rounded-md"
                            />
                            <label htmlFor='suffix_symbol_to_amount'
                                className="absolute left-3 -top-2 text-xs text-[#838383] bg-white px-1 transition-all peer-placeholder-shown:top-2 peer-placeholder-shown:text-sm peer-placeholder-shown:text-[#838383] peer-placeholder-shown:bg-transparent peer-focus:-top-2 peer-focus:text-xs peer-focus:text-[#838383] peer-focus:bg-white"
                            >
                        ...
                        <div className="relative">
                            <input
                                ...
                                value={organizedData.show_amount_of_millions}
                                onChange={handleInputChange}
                                ref={show_amount_of_millionsRef}
                                onKeyDown={(e) => handleKeyDown(e, decimal_valueRef, suffix_symbol_to_amountRef)}
                                placeholder=""
                                className="peer w-full h-9 px-2 text-sm border border-grayCustom focus:outline-none focus:border-purpleCustom rounded-md"
                            />
                            <label htmlFor='show_amount_of_millions'
                                className="absolute left-3 -top-2 text-xs text-[#838383] bg-white px-1 transition-all peer-placeholder-shown:top-2 peer-placeholder-shown:text-sm peer-placeholder-shown:text-[#838383] peer-placeholder-shown:bg-transparent peer-focus:-top-2 peer-focus:text-xs peer-focus:text-[#838383] peer-focus:bg-white"
                            >
                        ...
                        <div className="relative">
                            <input
                                ...
                                onKeyDown={(e) => handleKeyDown(e, formal_nameRef, show_amount_of_millionsRef)}
                                placeholder=""
                                className="peer w-full h-9 px-2 text-sm border border-grayCustom focus:outline-none focus:border-purpleCustom rounded-md"
                            />
                            <label htmlFor='decimal_value'
                                className="absolute left-3 -top-2 text-xs text-[#838383] bg-white px-1 transition-all peer-placeholder-shown:top-2 peer-placeholder-shown:text-sm peer-placeholder-shown:text-[#838383] peer-placeholder-shown:bg-transparent peer-focus:-top-2 peer-focus:text-xs peer-focus:text-[#838383] peer-focus:bg-white"
                            >
                               Decimal Value
                            </label>
                        ...
                        <div className="relative">
                            <input
                                ...
                                onChange={handleInputChange}
                                ref={formal_nameRef}
                                onKeyDown={(e) => handleKeyDown(e, add_space_between_amount_and_symbolRef, decimal_valueRef)}
                                placeholder=""
                                className="peer w-full h-9 px-2 text-sm border border-grayCustom focus:outline-none focus:border-purpleCustom rounded-md"
                            />
                            <label htmlFor='formal_name'
                                className="absolute left-3 -top-2 text-xs text-[#838383] bg-white px-1 transition-all peer-placeholder-shown:top-2 peer-placeholder-shown:text-sm peer-placeholder-shown:text-[#838383] peer-placeholder-shown:bg-transparent peer-focus:-top-2 peer-focus:text-xs peer-focus:text-[#838383] peer-focus:bg-white"
                            >
                               Formal Name
                            </label>
                        ...
                        <div className="relative">
                            <input
                                ...
                                value={organizedData.add_space_between_amount_and_symbol}
                                onChange={handleInputChange}
                                ref={add_space_between_amount_and_symbolRef}
                                onKeyDown={(e) => handleKeyDown(e, no_of_decimal_placesRef, formal_nameRef)}
                                placeholder=""
                                className="peer w-full h-9 px-2 text-sm border border-grayCustom focus:outline-none focus:border-purpleCustom rounded-md"
                            />
                            <label htmlFor='add_space_between_amount_and_symbol'
                                className="absolute left-3 -top-2 text-xs text-[#838383] bg-white px-1 transition-all peer-placeholder-shown:top-2 peer-placeholder-shown:text-sm peer-placeholder-shown:text-[#838383] peer-placeholder-shown:bg-transparent peer-focus:-top-2 peer-focus:text-xs peer-focus:text-[#838383] peer-focus:bg-white"
                            >
                        ...
                        <div className="relative">
                            <input
                                ...
                                onKeyDown={(e) => handleKeyDown(e, decimal_precisionRef, add_space_between_amount_and_symbolRef)}
                                placeholder=""
                                className="peer w-full h-9 px-2 text-sm border border-grayCustom focus:outline-none focus:border-purpleCustom rounded-md"
                            />
                            <label htmlFor='no_of_decimal_places'
                                className="absolute left-3 -top-2 text-xs text-[#838383] bg-white px-1 transition-all peer-placeholder-shown:top-2 peer-placeholder-shown:text-sm peer-placeholder-shown:text-[#838383] peer-placeholder-shown:bg-transparent peer-focus:-top-2 peer-focus:text-xs peer-focus:text-[#838383] peer-focus:bg-white"
                            >
                        ...
                        <div className="relative">
                            <input
                                ...
                                onKeyDown={(e) => handleKeyDown(e, null, no_of_decimal_placesRef)}
                                placeholder=""
                                className="peer w-full h-9 px-2 text-sm border border-grayCustom focus:outline-none focus:border-purpleCustom rounded-md"
                            />
                            <label htmlFor='decimal_precision'
                                className="absolute left-3 -top-2 text-xs text-[#838383] bg-white px-1 transition-all peer-placeholder-shown:top-2 peer-placeholder-shown:text-sm peer-placeholder-shown:text-[#838383] peer-placeholder-shown:bg-transparent peer-focus:-top-2 peer-focus:text-xs peer-focus:text-[#838383] peer-focus:bg-white"
                            >
                               Decimal Precision
                            </label>
