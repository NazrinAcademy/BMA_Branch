...
import successImage from '..//..//../assets/badge-check.png';
        ...
        <div className="bg-white h-full px-7 py-3 rounded shadow-md w-full max-w-6xl font-['Plus Jakarta Sans'] mx-auto">
            <div className="flex justify-between items-center border-b py-4">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="relative w-3/5">
                      ...
                      <Link to={"/addproduct"}
                         className="bg-[#593fa9] text-nowrap text-white px-4 py-2 text-base font-semibold rounded flex items-center gap-2">
                      Add Product
                      </Link>  
                </div>
            </div>
            ...
            <div className="overflow-x-auto">
                <div className="max-h-[360px] overflow-y-auto">
                    <table className="w-full border-collapse border text-center rounded">
                        ...
                        <tbody className="divide-y divide-gray-200 ">
                            {paginatedProducts.length > 0 ? (
                                paginatedProducts.map((product) => (
                                    <tr
                                        key={product.id}
                                        className="border-b text-base font-normal cursor-pointer"
