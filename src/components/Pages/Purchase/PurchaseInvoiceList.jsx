...
const PurchaseInvoiceList = () => {
  const invoices = [
    ...
    { id: "003", date: "11/02/2024", invoice_status: "Received", store: "Anil Electronics", mobile: "9876543212", amount: "₹ 1200", method: "Cash", status: "Un Paid" },
    { id: "004", date: "12/02/2024", invoice_status: "Received", store: "Mydeen Store", mobile: "9876543234", amount: "₹ 2500", method: "Cash", status: "Paid" },
    { id: "005", date: "12/02/2024", invoice_status: "Pending", store: "Fasil Papers", mobile: "3987120943", amount: "₹ 5000", method: "Card", status: "Un Paid" },
...
<div className="max-h-[350px] overflow-y-auto rounded border border-[#c9c9cd]">
      <table className="w-full ">
        ...
        <tr className="text-sm font-semibold">
          ...
          {["Invoice No", "Date", "Invoice Status", "Billing From", "Mobile No", "Amount", "Payment Method", "Payment Status"].map((heading, index) => (
        ...
        {paginatedInvoices.length > 0 ? (
          paginatedInvoices.map((invoice) => (
            ...
            >
              ...
              {["id", "date", "store", "mobile", "amount", "method"].map((key) => (
              ...
              {/* Invoice Status Column with Dynamic Styling */}
