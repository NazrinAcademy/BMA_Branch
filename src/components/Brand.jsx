...
const Brand = () => {
            ...
            try {
                ...
                setBrands((prevBrands) =>
                    prevBrands.map((brand) =>
                        brand.id === editingBrand ? updatedBrand : brand
                    )
                );
  ...
  {paginatedBrands.length > 0 ? (
    paginatedBrands.map((brand, index) => (
      <tr key={brand.id || index} className="border-b text-base font-normal"
          ...
          {editingBrand === brand.id ? (
            <input
             ...
             value={updatedBrand?.name || ""}
              onChange={(e) => handleInputChange(e, "name")}  // Changed from "categoryName" to "name"
