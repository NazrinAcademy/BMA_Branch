...
const ordersData = {
  Logistics: [  // Changed from "QC" to "Logistics"
    {
      id: "1",
    ...
    },
    {
      ...
      status: "Ready to Delivery",
      products: [
        { productName: "Sofa Set", quantity: 1, productCode: "SS789", defected: 2  },
      ],
    },
  ],
  Defected: [
    {
      ...
      products: [
        { productName: "Refrigerator", quantity: 19, productCode: "RF101" },
        { productName: "Refrigeratorq", quantity: 11, productCode: "sRF101" },
        { productName: "Refrigeratora", quantity: 12, productCode: "eRF101" },
        { productName: "Refrigerators", quantity: 9, productCode: "uRF101" },
      ],
    },
  ],
  Delivered: [
...
const QcOrder = ({ navigation }) => {
  const [activeTab, setActiveTab] = useState("Logistics");  // Changed from "QC" to "Logistics"
      ...
      <ScrollView style={styles.listContainer}>
        {filteredOrders.map((item) => (
          <TouchableOpacity
            ...
            onPress={() => {
              if (activeTab === "Defected") {
                navigation.navigate("Defected", { order: item });
              } else {
                navigation.navigate("QcOrderDetails", { order: item });
              }
            }}
          >
            <View style={styles.orderInfo}>
              ...
              <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                ...
                {activeTab === "Defected" ? (
                  ...
                  <Text style={styles.orderPhone2}>Delivery Date: {item.date}</Text>
                )}
              </View>
            </View>
          </TouchableOpacity>
