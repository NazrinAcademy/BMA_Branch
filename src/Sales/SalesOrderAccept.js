...
const SalesOrderAccept = ({ route, navigation }) => {
    // const { order, removeRejectedOrder } = route.params;
    ...
    const handleCancel = () => {
        console.log("Cancel button clicked. Closing the page...");
        navigation.goBack();
    };
    ...
    const handleReorder = () => {
        ...
        navigation.navigate('SalesOrder', { reorderOrderId: order.id });
        console.log("Reorder logged in SalesOrderAccept");
        navigation.goBack();
    };
    return (
        <View style={styles.container}>
            ...
            <View style={styles.saveContainer}>
                ...
                <TouchableOpacity style={styles.saveButton1} onPress={handleReorder}>
                    <Text style={styles.saveButtonText1}>Reorder</Text>
                </TouchableOpacity>
            </View>
        </View>
    );
