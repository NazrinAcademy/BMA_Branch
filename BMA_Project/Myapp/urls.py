...
urlpatterns = [
    ...
    path('customer/producet/cal', views.customer_product_calculation, name=' customer_product_calculation'),
    path('balance/api/calculation', views.balance_calculation, name=' balance_calculation'),
    ...
    path('verify/api/responce', views.verify_code, name='verify_code'),
    path('accesskey/api/add', views.add_access_key, name='add_access_key'),
    path('accesskey/api/get', views.accesskey_get, name='accesskey_get'),
    path('accesskey/api/update', views.accesskey_update, name='accesskey_update'),
    path('accesskey/api/delete', views.accesskey_delete, name='accesskey_delete'),
    
    path('sale/ledger/api/add', views.customer_sale_add, name='customer_sale'),
]
